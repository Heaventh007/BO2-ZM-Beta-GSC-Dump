...
reference_anims_from_animtree()
{
    ...
    dummy_anim_ref = %ai_zombie_mech_ft_intro_to_aim_5;
    dummy_anim_ref = %ai_zombie_mech_ft_outtro_from_aim_5;
    ...
    dummy_anim_ref = %ai_zombie_mech_grapple_intro_to_aim_5;
    dummy_anim_ref = %ai_zombie_mech_grapple_outtro_from_aim_5;
    ...
    dummy_anim_ref = %ai_zombie_mech_jump_up_72;
