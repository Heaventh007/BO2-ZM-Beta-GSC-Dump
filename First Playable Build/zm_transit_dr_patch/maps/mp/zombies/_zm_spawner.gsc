...
init()
{
    ...
    registerclientfield( "actor", "sndZombieContext", 9000, 1, "int" );
}
...
zombie_spawn_init( animname_set )
{
    ...
    if ( isdefined( level.sndzombieentcontext ) && level.sndzombieentcontext )
        self setclientfield( "sndZombieContext", 1 );
