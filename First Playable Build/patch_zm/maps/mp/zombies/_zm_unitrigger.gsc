...
assess_and_apply_visibility( trigger, stub, player )
{
    ...
    while ( true )
    {
        ...
        for ( i = 0; i < players.size; i++ )
        {
            ...
            if ( isdefined( trigger ) )
            {
                ...
                {
                    if ( assess_and_apply_visibility( trigger, trigger.stub, player ) )
                        continue;
                }
            ...
            while ( index < closest.size )
            {
                ...
                if ( isdefined( trigger ) )
                {
                    ...
                    if ( assess_and_apply_visibility( trigger, closest[index], player ) )
                        break;
