...
register_clientfields()
{
    ...
    bits = 3;
    registerclientfield( "world", "segments_staff1", 14000, bits, "int", undefined, 0, 1 );
    registerclientfield( "world", "segments_staff2", 14000, bits, "int", undefined, 0, 1 );
    registerclientfield( "world", "segments_staff3", 14000, bits, "int", undefined, 0, 1 );
    registerclientfield( "world", "segments_staff4", 14000, bits, "int", undefined, 0, 1 );
    setupclientfieldcodecallbacks( "world", 1, "segments_staff1" );
    setupclientfieldcodecallbacks( "world", 1, "segments_staff2" );
    setupclientfieldcodecallbacks( "world", 1, "segments_staff3" );
    setupclientfieldcodecallbacks( "world", 1, "segments_staff4" );
