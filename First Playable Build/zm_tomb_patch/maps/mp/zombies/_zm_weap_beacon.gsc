...
#/
    registerclientfield( "actor", "play_launch_artillery_fx", 14000, 1, "int" );
    registerclientfield( "scriptmover", "play_beacon_fx", 14000, 1, "int" );
    registerclientfield( "scriptmover", "play_artillery_barrage", 14000, 1, "int" );
...
player_handle_beacon()
{
    ...
    while ( true )
    {
        ...
        self player_throw_beacon( grenade, num_attractors, max_attract_dist, attract_dist_diff );
        wait 0.05;
    }
}
...
player_throw_beacon( grenade, num_attractors, max_attract_dist, attract_dist_diff )
{
    ...
    if ( isdefined( grenade ) )
    {
        ...
        model setmodel( "zm_lights_lantern_vactube" );
        ...
        if ( isdefined( grenade ) )
        {
            ...
            if ( valid_poi )
            {
                ...
                model thread artillery_fx_logic();
                model thread artillery_barrage_logic( grenade );
...
artillery_fx_logic()
{
    sp_giant_robot = getent( "giant_robot_walker", "targetname" );
    ...
    sp_giant_robot setclientfield( "play_launch_artillery_fx", 1 );
    wait 0.5;

    if ( isdefined( sp_giant_robot ) )
        sp_giant_robot setclientfield( "play_launch_artillery_fx", 0 );
}

artillery_barrage_logic( grenade )
{
    wait 3;
    self setclientfield( "play_artillery_barrage", 1 );
    wait 5;

    for ( i = 0; i < 5; i++ )
    {
        radiusdamage( self.origin + vectorscale( ( 0, 0, 1 ), 12.0 ), 200, 5000, 1200, self.owner, "MOD_GRENADE_SPLASH", "beacon_zm" );
        wait 1;
    }
