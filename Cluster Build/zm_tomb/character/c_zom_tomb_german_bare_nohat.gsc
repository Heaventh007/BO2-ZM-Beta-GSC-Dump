...
main()
{
    self setmodel( "c_zom_tomb_german_body2_nohat" );
    self.headmodel = codescripts\character::randomelement( xmodelalias\c_zom_tomb_german_head_als::main() );
    self attach( self.headmodel, "", 1 );
    self.voice = "american";
    self.skeleton = "base";
    self.torsodmg1 = "c_zom_tomb_german_body2_g_upclean";
    self.torsodmg2 = "c_zom_tomb_german_body2_g_rarm";
    self.torsodmg3 = "c_zom_tomb_german_body2_g_larm";
...
precache()
{
    precachemodel( "c_zom_tomb_german_body2_nohat" );
    codescripts\character::precachemodelarray( xmodelalias\c_zom_tomb_german_head_als::main() );
    precachemodel( "c_zom_tomb_german_body2_g_upclean" );
    precachemodel( "c_zom_tomb_german_body2_g_rarm" );
    precachemodel( "c_zom_tomb_german_body2_g_larm" );
