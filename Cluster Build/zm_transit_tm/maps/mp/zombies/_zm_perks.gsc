...
register_perk_thread( perk_name, func )
{
    if ( !isdefined( level._custom_perk_threads[perk_name] ) )
        level._custom_perk_threads[perk_name] = func;
}
...
vending_machine_trigger_think()
{
    ...
    while ( true )
    {
        ...
        {
            if ( players[i] hacker_active() || "riotshield_zm" == players[i] getcurrentweapon() )
            {
...
{
    maps\mp\zombies\_zm_perk_electric_cherry::init();
...
give_perk( perk, bought )
{
    ...
    if ( perk == "specialty_nomotionsensor" )
        self maps\mp\zombies\_zm_perk_vulture::give_vulture_perk();

    if ( isdefined( level._custom_perk_threads[perk] ) )
        self thread [[ level._custom_perk_threads[perk] ]]();
...
#/
    ...
    switch ( perk )
    {
        ...
        case "specialty_deadshot_upgrade":
            ...
            break;
        case "specialty_nomotionsensor":
            self maps\mp\zombies\_zm_perk_vulture::take_vulture_perk();
            break;
    }
...
perk_hostmigration()
{
    ...
    while ( true )
    {
        ...
        foreach ( perk in electric_cherry )
        {
            if ( isdefined( perk.model ) && perk.model == "zombie_vending_revive_on" )
            {
                perk perk_fx( undefined, 1 );
