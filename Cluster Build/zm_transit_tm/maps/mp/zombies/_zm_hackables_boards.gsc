...
board_hack( hacker )
{
    ...
    while ( true )
    {
        ...
        chunk = get_random_destroyed_chunk( self, self.window.barrier_chunks );

        if ( !isdefined( chunk ) )
            break;

        self.window thread maps\mp\zombies\_zm_blockers::replace_chunk( self, chunk, undefined, 0, 1 );
