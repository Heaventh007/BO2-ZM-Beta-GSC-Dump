...
eqstub_get_unitrigger_origin()
{
    ...
    return self.origin + vectorscale( ( 0, 0, 1 ), 12.0 );
}
...
placed_equipment_think( model, equipname, origin, angles, tradius, toffset )
{
    ...
    pickupmodel.stub = generate_equipment_unitrigger( "trigger_radius_use", torigin + vectorscale( ( 0, 0, 1 ), 12.0 ), angles, 0, tradius, 64, hint, icon, ::placed_equipment_unitrigger_think, isdefined( pickupmodel.canmove ) && pickupmodel.canmove );
...
placed_equipment_unitrigger_think()
{
    ...
    while ( true )
    {
        ...
        if ( !player can_pick_up_equipment( self.stub.equipname ) )
            continue;
...
dropped_equipment_think( model, equipname, origin, angles, tradius, toffset )
{
    ...
    pickupmodel.stub = generate_equipment_unitrigger( "trigger_radius_use", torigin, angles, 0, tradius, 64, hint, icon, ::dropped_equipment_unitrigger_think, isdefined( pickupmodel.canmove ) && pickupmodel.canmove );
    pickupmodel.stub.model = pickupmodel;
    pickupmodel.stub.equipname = equipname;
    pickupmodel.equipname = equipname;
