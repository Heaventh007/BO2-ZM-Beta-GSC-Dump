...
player_can_build( buildable, continuing )
{
    ...
    else if ( buildable buildable_is_piece_built_or_building( self.current_buildable_piece ) )
        return false;
...
buildablestub_update_prompt( player )
{
    ...
    if ( !( isdefined( self.built ) && self.built ) )
    {
        ...
        else if ( !self.buildablezone buildable_has_piece( player.current_buildable_piece ) )
        {
...
buildable_place_think()
{
    ...
    else if ( !isdefined( player_built ) || self buildabletrigger_update_prompt( player_built ) )
    {
        if ( isdefined( self.stub.model ) )
        {
            self.stub.model notsolid();
