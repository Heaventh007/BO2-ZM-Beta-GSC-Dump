...
{
    self.accuracy = 0.2;
    self.animstatedef = "zm_factory_dog.asd";
    self.animtree = "zm_factory_dog.atr";
    self.csvinclude = "";
...
precache( ai_index )
{
    ...
    precacheanimstatedef( ai_index, #animtree, "zm_factory_dog" );
