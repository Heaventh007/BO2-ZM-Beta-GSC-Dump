...
#using_animtree("zm_asylum_basic");
...
{
    self.accuracy = 1;
    self.animstatedef = "zm_asylum_basic.asd";
    self.animtree = "zm_asylum_basic.atr";
    self.csvinclude = "";
...
precache( ai_index )
{
    ...
    precacheanimstatedef( ai_index, #animtree, "zm_asylum_basic" );
