...
giveloadout( team, class )
{
    ...
    if ( issubstr( class, "CLASS_CUSTOM" ) )
    {
        ...
        if ( !isdefined( self.class_num ) || self.class_num != class_num )
            classchanged = 1;
...
#/
    ...
    if ( isdefined( self.spawnweapon ) && doesweaponreplacespawnweapon( self.spawnweapon, spawnweapon ) && !classchanged )
