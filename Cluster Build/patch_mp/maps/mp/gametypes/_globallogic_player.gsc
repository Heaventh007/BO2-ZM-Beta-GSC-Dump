        ...
        else if ( smeansofdeath == "MOD_MELEE" )
        {
            if ( sweapon == "riotshield_mp" )
            {
                ...
                if ( isdefined( attacker.class_num ) )
                {
                    ...
                    primarygenadenum = attacker getloadoutitem( attacker.class_num, "primarygrenade" );

                    if ( ( primaryweaponnum && level.tbl_weaponids[primaryweaponnum]["reference"] == "riotshield" && !secondaryweaponnum || secondaryweaponnum && level.tbl_weaponids[secondaryweaponnum]["reference"] == "riotshield" && !primaryweaponnum ) && !primarygenadenum )
