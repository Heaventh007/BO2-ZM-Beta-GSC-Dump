...
usecarriedkillstreakweapon( hardpointtype )
{
    ...
    if ( isfrominventory )
        self maps\mp\gametypes\_class::setweaponammooverall( hardpointtype, self.pers["killstreak_ammo_count"][self.pers["killstreak_ammo_count"].size - 1] );
...
watchkillstreakweaponswitch( killstreakweapon, killstreak_id, isfrominventory )
{
    ...
    while ( true )
    {
        ...
        if ( currentammo == 0 || self.pers["killstreak_quantity"][killstreakweapon] > 0 || isdefined( killstreakid ) && killstreakid != killstreak_id )
        {
...
watchkillstreakweapondeath( hardpointtype, killstreak_id, isfrominventory )
{
    ...
    if ( newammo <= 0 || self.pers["killstreak_quantity"][hardpointtype] > 0 || isdefined( killstreakid ) && killstreakid != killstreak_id )
    {
        ...
        if ( self.pers["killstreak_quantity"][hardpointtype] > 0 )
        {
            ...
            self maps\mp\gametypes\_class::setweaponammooverall( hardpointtype, self.pers["held_killstreak_ammo_count"][hardpointtype] );
