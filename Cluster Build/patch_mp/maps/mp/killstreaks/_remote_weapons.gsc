...
initremoteweapon( weapon, weaponname )
{
    ...
    if ( isdefined( self.remoteweapon ) )
        ...
        self thread setactiveremotecontrolledweapon( weapon, weaponname );
}
...
setactiveremotecontrolledweapon( weapon, weaponname )
{
...
collectweaponpings()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( best_weapon ) )
            self thread setactiveremotecontrolledweapon( best_weapon, weapon.remotename );
    }
}
