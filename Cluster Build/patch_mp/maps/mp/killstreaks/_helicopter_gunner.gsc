...
inithelicopter( isdriver, hardpointtype )
{
    ...
    self.heli thread maps\mp\_heatseekingmissile::missiletarget_lockonmonitor( self, "crashing", "leaving" );
    self.heli thread maps\mp\_heatseekingmissile::missiletarget_proximitydetonateincomingmissile( "crashing", "leaving" );
