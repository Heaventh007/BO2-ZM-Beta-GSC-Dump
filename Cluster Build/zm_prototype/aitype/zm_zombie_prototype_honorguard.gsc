...
#include character\c_ger_honorguard_zombie;

#using_animtree("zm_prototype_basic");
...
reference_anims_from_animtree()
{
    ...
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_1_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_2_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_3_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_4_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_5_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_6_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_1_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_2_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_3_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_4_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_5_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_6_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_1_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_2_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_3_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_4_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_5_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_6_grab;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_1_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_2_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_3_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_4_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_5_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_6_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_1_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_2_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_3_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_4_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_5_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_6_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_1_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_2_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_3_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_4_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_5_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_6_hold;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_1_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_2_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_3_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_4_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_5_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_m_6_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_1_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_2_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_3_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_4_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_5_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_r_6_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_1_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_2_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_3_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_4_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_5_pull;
    dummy_anim_ref = %ai_zombie_walltear_proto_aligned_l_6_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_1_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_2_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_3_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_4_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_5_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_6_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_1_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_2_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_3_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_4_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_5_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_6_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_1_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_2_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_3_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_4_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_5_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_6_grab;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_1_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_2_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_3_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_4_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_5_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_6_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_1_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_2_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_3_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_4_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_5_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_6_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_1_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_2_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_3_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_4_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_5_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_6_hold;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_1_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_2_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_3_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_4_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_5_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_m_6_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_1_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_2_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_3_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_4_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_5_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_r_6_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_1_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_2_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_3_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_4_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_5_pull;
    dummy_anim_ref = %ai_zombie_crawl_walltear_proto_aligned_l_6_pull;
...
{
    self.accuracy = 1;
    self.animstatedef = "zm_prototype_basic.asd";
    self.animtree = "zm_prototype_basic.atr";
    self.csvinclude = "";
    ...
    character\c_ger_honorguard_zombie::main();
...
precache( ai_index )
{
    ...
    precacheanimstatedef( ai_index, #animtree, "zm_prototype_basic" );
    character\c_ger_honorguard_zombie::precache();
}
