...
reference_anims_from_animtree()
{
    ...
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap1_to_antenna;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap1_from_antenna;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap2_from_roof;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap2_to_roof;
    ...
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14a_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14b_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14c_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14c_low_to_high;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14d_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14d_low_to_high;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14e_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14e_low_to_high;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14f_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14f_low_to_high;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14g_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14g_low_to_high;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14h_high_to_low;
    dummy_anim_ref = %ai_zombie_traverse_dierise_gap14h_low_to_high;
    ...
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap1_to_antenna;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap1_from_antenna;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap2_from_roof;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap2_to_roof;
    ...
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14a_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14b_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14c_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14c_low_to_high;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14d_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14d_low_to_high;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14e_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14e_low_to_high;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14f_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14f_low_to_high;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14g_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14g_low_to_high;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14h_high_to_low;
    dummy_anim_ref = %ai_zombie_crawl_traverse_dierise_gap14h_low_to_high;
