...
#include maps\mp\createart\zm_pentagon_art;
#include maps\mp\createfx\zm_pentagon_fx;

main()
{
    scriptedfx();
    footsteps();
    maps\mp\createart\zm_pentagon_art::main();
    maps\mp\createfx\zm_pentagon_fx::main();
    precachefx();
}
