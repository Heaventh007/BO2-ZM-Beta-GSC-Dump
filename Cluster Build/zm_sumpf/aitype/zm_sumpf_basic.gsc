...
#include character\c_jap_impinf_zombie;
...
reference_anims_from_animtree()
{
    ...
    dummy_anim_ref = %ai_zombie_walk_v8;
    ...
    dummy_anim_ref = %ai_zombie_crawl_jump_down_190;
    dummy_anim_ref = %mantle_over_40_hurdle;
    dummy_anim_ref = %mantle_over_40_hurdle_crawl;
}

main()
{
    self.accuracy = 1;
    self.animstatedef = "zm_sumpf_basic.asd";
    self.animtree = "zm_sumpf_basic.atr";
    self.csvinclude = "";
    ...
    character\c_jap_impinf_zombie::main();
...
precache( ai_index )
{
    ...
    character\c_jap_impinf_zombie::precache();
}
