...
main()
{
    self._gib_def = level._gibbing_actor_models["c_usa_pent_zombie_officeworker_body"];
}
...
register_gibs()
{
    ...
    level._gibbing_actor_models["c_usa_pent_zombie_officeworker_body"] = gib_spawn;
}
