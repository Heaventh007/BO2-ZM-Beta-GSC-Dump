...
#include maps\mp\createfx\zm_theater_fx;
#include maps\mp\createart\zm_theater_art;
...
main()
{
    ...
    precachefx();
    footsteps();
    maps\mp\createfx\zm_theater_fx::main();
    maps\mp\createart\zm_theater_art::main();
}
...
precachefx()
{
    ...
    level._effect["fx_mp_light_lamp"] = loadfx( "maps/zombie_old/fx_mp_light_lamp" );
    ...
    level._effect["fx_mp_insects_lantern"] = loadfx( "maps/zombie_old/fx_mp_insects_lantern" );
